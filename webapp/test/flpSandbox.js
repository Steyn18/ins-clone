						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#progressindicator-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"progressindicator-display": {
								"semanticObject": "progressindicator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=progressindicator",
									"url": sap.ui.require.toUrl("progressindicator")
								}
							}
						}
					}
